...
function(setup_ps3_pkg target title appid contentid icon contentfolder)
    ...
    psl1ght_pkg_step3(${target} ${title} ${icon} ${appid} ${contentid} "YES")
...
function(setup_ps3_pkg_nc target title appid contentid icon)
    psl1ght_pkg_step1(${target} ${title} ${icon} ${appid} ${contentid})
    psl1ght_pkg_step3(${target} ${title} ${icon} ${appid} ${contentid} "NO")
...
function(psl1ght_pkg_step3 target title icon appid contentid content)
    if (content)
