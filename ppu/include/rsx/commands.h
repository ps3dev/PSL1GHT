...
void rsxSetTransformBranchBits(gcmContextData *context,u32 branchBits);
   ...
   */
void rsxSetTransferData(gcmContextData * context,uint8_t mode,uint32_t dst,uint32_t outpitch,uint32_t src,uint32_t inpitch,uint32_t linelength,uint32_t linecount);
