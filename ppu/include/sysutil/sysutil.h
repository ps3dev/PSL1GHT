...
#ifndef __LV2_CELL_SYSUTIL_H__
#define __LV2_CELL_SYSUTIL_H__

#include <ppu-types.h>

/*! \brief Return value */
#define CELL_SYSUTIL_OK                              0

/*! \brief Event slot 0 */
#define CELL_SYSUTIL_EVENT_SLOT0			0
/*! \brief Event slot 1 */
#define CELL_SYSUTIL_EVENT_SLOT1			1
/*! \brief Event slot 2 */
#define CELL_SYSUTIL_EVENT_SLOT2			2
/*! \brief Event slot 3 */
#define CELL_SYSUTIL_EVENT_SLOT3			3

/*! \brief Exit game requested. */
#define CELL_SYSUTIL_EXIT_GAME			0x0101
/*! \brief Beginning of XMB menu drawing. */
#define CELL_SYSUTIL_DRAW_BEGIN			0x0121
/*! \brief End of XMB menu drawing. */
#define CELL_SYSUTIL_DRAW_END			0x0122
/*! \brief XMB menu has been opened. */
#define CELL_SYSUTIL_MENU_OPEN			0x0131
/*! \brief XMB menu has been closed. */
#define CELL_SYSUTIL_MENU_CLOSE			0x0132
/*! \brief On-screen keyboard has been loaded. */
#define CELL_SYSUTIL_OSK_LOADED                      0x0502
/*! \brief On-screen keyboard has finished a user entry. */
#define CELL_SYSUTIL_OSK_DONE                        0x0503
/*! \brief On-screen keyboard has been unloaded. */
#define CELL_SYSUTIL_OSK_UNLOADED                    0x0504
/*! \brief On-screen keyboard user entered input. */
#define CELL_SYSUTIL_OSK_INPUT_ENTERED               0x0505
/*! \brief On-screen keyboard has canceled input. */
#define CELL_SYSUTIL_OSK_INPUT_CANCELED              0x0506
...
#define CELL_SYSUTIL_LANG_JAPANESE           0   // Japanese 
#define CELL_SYSUTIL_LANG_ENGLISH_US         1   // English (United States) 
#define CELL_SYSUTIL_LANG_FRENCH             2   // French 
#define CELL_SYSUTIL_LANG_SPANISH            3   // Spanish 
#define CELL_SYSUTIL_LANG_GERMAN             4   // German 
#define CELL_SYSUTIL_LANG_ITALIAN            5   // Italian 
#define CELL_SYSUTIL_LANG_DUTCH              6   // Dutch 
#define CELL_SYSUTIL_LANG_PORTUGUESE_PT      7   // Portuguese (Portugal) 
#define CELL_SYSUTIL_LANG_RUSSIAN            8   // Russian 
#define CELL_SYSUTIL_LANG_KOREAN             9   // Korean 
#define CELL_SYSUTIL_LANG_CHINESE_T          10  // Chinese (traditional) 
#define CELL_SYSUTIL_LANG_CHINESE_S          11  // Chinese (simplified) 
#define CELL_SYSUTIL_LANG_FINNISH            12  // Finnish 
#define CELL_SYSUTIL_LANG_SWEDISH            13  // Swedish 
#define CELL_SYSUTIL_LANG_DANISH             14  // Danish 
#define CELL_SYSUTIL_LANG_NORWEGIAN          15  // Norwegian 
#define CELL_SYSUTIL_LANG_POLISH             16  // Polish 
#define CELL_SYSUTIL_LANG_PORTUGUESE_BR      17  // Portuguese (Brazil) 
#define CELL_SYSUTIL_LANG_ENGLISH_GB         18  // English (United Kingdom) 
#define CELL_SYSUTIL_LANG_TURKISH            19  // Turkish 
...
/*! \brief Pointer to callback function.
  ...
  \param status Event value. Possible values are:
    - \ref CELL_SYSUTIL_EXIT_GAME
    - \ref CELL_SYSUTIL_DRAW_BEGIN
    - \ref CELL_SYSUTIL_DRAW_END
    - \ref CELL_SYSUTIL_MENU_OPEN
    - \ref CELL_SYSUTIL_MENU_CLOSE
    - \ref CELL_SYSUTIL_OSK_LOADED
    - \ref CELL_SYSUTIL_OSK_DONE
    - \ref CELL_SYSUTIL_OSK_UNLOADED
    - \ref CELL_SYSUTIL_OSK_INPUT_CANCELED
  \param param Event parameter, depending on event value.
  \param usrdata Pointer to user data as provided to the
      \ref cellSysutilRegisterCallback function.
*/
typedef void (*CellSysutilCallback)(u64 status,u64 param,void *usrdata);
...
registered using \ref cellSysutilRegisterCallback) is called.
*/
...
to all 4 slots in order, so each manager will see all of them.
  ...
  \param slot Event slot identifier. Possible values are:
    - \ref CELL_SYSUTIL_EVENT_SLOT0
    - \ref CELL_SYSUTIL_EVENT_SLOT1
    - \ref CELL_SYSUTIL_EVENT_SLOT2
    - \ref CELL_SYSUTIL_EVENT_SLOT3
